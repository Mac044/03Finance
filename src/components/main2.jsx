...
const Main2 = () => {
  return (
    <div>
       ...
       <div className="bg-[url(/10/hero.png.jpg)] md:w-auto h-96 bg-no-repeat py-96 bg-right-top relative"> </div>
       ...
       <div className=" px-48">
       <div className=" w-full h-24 md:bg-slate-100 mt-36 flex justify-around pt-3">
